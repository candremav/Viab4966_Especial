...
from Funcoes_Viab4966_FC import Viab4966_FC

# Lê a curva do CDI
df_cdi = pd.read_csv('7.9.9Juros_Pos.csv', parse_dates=['Data'])

st.set_page_config(page_title="Simulador de Viabilidade 4966 (Fluxo de Caixa Modificado)", layout="wide")
st.title("Viabilidade de Contratos - Modelo 4966 (Fluxo de Caixa Modificado)")
...
with st.sidebar:
    ...
    base_g_mes = st.number_input("Crescimento mensal do número de contratos (%)", value=0.0, format="%.2f") / 100
